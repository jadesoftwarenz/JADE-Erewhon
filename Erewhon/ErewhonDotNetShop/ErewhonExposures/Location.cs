...
namespace ErewhonExposures
{
	...
	[System.ComponentModel.DataAnnotations.MetadataTypeAttribute(typeof(LocationMetadata))]
	[JadeSoftware.Joob.Client.JoobClassAttribute("Location", "RootSchema.CardSchema.ErewhonBaseSchema.ErewhonModelSchema", ClassNamespace="ErewhonExposures")]
	[JadeSoftware.Joob.Metadata.JomlTypeAttribute(JadeSoftware.Joob.Metadata.JomlTypeKind.Class, "Location", typeof(PersistentModel))]
	public partial class Location : PersistentModel
	{
		private static LocationMetadata _metaModel;
		partial void _initialize();
		static Location()
		{
			_metaModel = MetadataCache<LocationMetadata>.GetData(null);
		}
		public Location() :
			this(JadeSoftware.Joob.ClassPersistence.Persistent)
		{
		}
		public Location(JadeSoftware.Joob.ClassPersistence lifetime) :
			base(lifetime, typeof(Location), _metaModel.metaClass)
		{
			this._initialize();
		}
		protected Location(JadeSoftware.Joob.ClassPersistence lifetime, System.Type type, JadeSoftware.Joob.ClassMetadata metaClass, params System.Object[] parameters) :
...
#region Jade Properties
	...
	public partial class LocationMetadata : JadeSoftware.Joob.IDomainMetadata
	{
		...
		public LocationMetadata(JadeSoftware.Joob.Client.JoobConnection connection)
		{
			metaClass = new JadeSoftware.Joob.ClassMetadata(connection, typeof(Location), "Location", "RootSchema.CardSchema.ErewhonBaseSchema.ErewhonModelSchema");
